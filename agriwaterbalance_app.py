...
# User Interface
st.markdown('<div style="text-align: center;"><img src="agriwaterbalance/logo.png" alt="Logo" style="max-width: 200px; margin-bottom: 10px;"></div>', unsafe_allow_html=True)
